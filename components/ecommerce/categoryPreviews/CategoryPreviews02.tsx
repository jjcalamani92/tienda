                    ...
                    <div className="flex flex-col jusitfy-center items-center space-y-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 md:gap-x-8 w-full">
                            ...
                            <div className="flex flex-col space-y-4 md:space-y-8 mt-4 md:mt-0">
                                ...
                                <div className="relative group flex justify-center items-center h-full w-full">
                                    <img className="object-center object-cover h-full w-full" src={featured[2].imageSrc} alt="watch-image" />
                        ...
                        <div className="relative group hidden md:flex justify-center items-center h-full w-full mt-4 md:mt-8 lg:hidden">
                            <img className="object-center object-cover h-full w-full hidden md:block" src={featured[3].imageSrc} alt="girl-image" />
                            <img className="object-center object-cover h-full w-full sm:hidden" src={featured[3].imageSrc} alt="olive-tatiane-Im-Ez-F9-B91-Mk-unsplash-2" />
                            <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 bottom-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 w-36 bg-white">Women</button>
                            <div className="absolute opacity-0 group-hover:opacity-100 transition duration-500 bottom-3 py-6 z-0 px-20 w-36 bg-white bg-opacity-50" />
                        </div>
                        </div>
